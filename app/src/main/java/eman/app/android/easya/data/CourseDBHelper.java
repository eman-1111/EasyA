...
public class CourseDBHelper  extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_SUBJECT_TABLE = "CREATE TABLE " + CourseContract.SubjectEntry.TABLE_NAME + " (" +
                ...
                CourseContract.SubjectEntry.COLUMN_LESSON_OUTLINE_IMAGE+ " TEXT , " +
                CourseContract.SubjectEntry.COLUMN_LESSON_LINK + " TEXT , " +
                CourseContract.SubjectEntry.COLUMN_LESSON_LINK_IMAGE + " TEXT , " +
                CourseContract.SubjectEntry.COLUMN_LESSON_DEBUG + " TEXT ," +
                CourseContract.SubjectEntry.COLUMN_LESSON_DEBUG_IMAGE + " TEXT ," +
                CourseContract.SubjectEntry.COLUMN_LESSON_PRACTICAL_TITLE + " TEXT , " +
                CourseContract.SubjectEntry.COLUMN_FAVORITE + " INTEGER , " +
                CourseContract.SubjectEntry.COLUMN_LESSON_PRACTICAL_IMAGE + " TEXT , " +
